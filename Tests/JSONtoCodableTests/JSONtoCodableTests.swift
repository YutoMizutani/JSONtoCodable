...
class JSONtoCodableTests: XCTestCase {
    ...
    func testDecisionType() {
        ...
        XCTAssertEqual(self.base.decisionType("-10", isString: true), .string)
        ...
        XCTAssertEqual(self.base.decisionType("-10.0", isString: true), .string)
        ...
        XCTAssertEqual(self.base.decisionType("-10", isString: false), .int)
        ...
        XCTAssertEqual(self.base.decisionType("-10.0", isString: false), .double)
